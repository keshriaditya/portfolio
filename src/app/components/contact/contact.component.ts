...
export class ContactComponent implements OnInit {
  ...
  socialLinks: SocialLink[] = [
    {
      name: 'GitHub',
      url: 'https://github.com/keshriaditya',
      icon: 'code',
      color: '#333333'
    },
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/keshriaditya',
      icon: 'work',
      color: '#0077b5'
    },
    {
      name: 'Twitter',
      url: 'https://twitter.com/keshriadityaa',
      icon: 'alternate_email',
      color: '#1da1f2'
    },
    // {
    //   name: 'Instagram',
    //   url: 'https://instagram.com/keshriaditya',
    //   icon: 'camera_alt',
    //   color: '#e4405f'
    // },
    // {
    //   name: 'YouTube',
    //   url: 'https://youtube.com/keshriaditya',
    //   icon: 'play_circle',
    //   color: '#ff0000'
    // },
    // {
    //   name: 'Discord',
    //   url: 'https://discord.gg/keshriaditya',
    //   icon: 'chat',
    //   color: '#7289da'
    // }
  ];
  ...
  contactInfo: ContactInfo[] = [
    {
      icon: 'email',
      title: 'Email',
      value: 'akkeshriaditya@gmail.com',
      link: 'mailto:akkeshriaditya@gmail.com'
    },
    {
      icon: 'phone',
      title: 'Phone',
      value: '+91 9560061303',
      link: 'tel:+919560061303'
    },
    {
      icon: 'location_on',
      title: 'Location',
